            ...
            <div className="row mx-0">
              ...
              <div className="col-lg-4">
                ...
                <div className="row">
                  ...
                  {model && (
					<>
						{model.nationality && (<div className="col-6">
				  ...
				  {model && (
					<>
						{model.dressSize && (<div className="col-6">
										<p>{model.dressSize}</p>
									</div>)}
					</>
					)}
				  ...
				  {model && (
					<>
						{model.height && (<div className="col-6">
										<p>{model.height}</p>
									</div>)}
					</>
					)}
				  ...
				  {model && (
					<>
						{model.hairColor && (<div className="col-6">
										<p>{model.hairColor}</p>
									</div>)}
					</>
					)}
              ...
              <div className="col-lg-4">
				...
				{model && (
				<>
					{model.modelDescription && <p>{model.modelDescription}</p>}
				</>
				)}
            ...
            <div className="row girlImageGallery">
              ...
              {galleryImages.map(image => (
			   ...
			   <img
				 ...
				 src={`${process.env.NEXT_PUBLIC_STORAGE_URL}/${image.image}`} alt={`Gallery Image ${image.id}`} 
			   />
			 </div>
            ))}
            </div>
