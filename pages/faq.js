        ...
        <div className="my-5">
          ...
          {faqs.map((faq) => (
            <div className="accordion-item">
              <button onClick={() => toggleItem(faq.id)} className="accordion-button" id="headingOne" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
